    ...
    highlight_overrides = {
        all = function(c)
            return {
                ...
                MatchParen = { fg = c.text, bg = c.lavender },
                Type = { fg = c.mauve },
                Visual = { bg = c.sapphire },
                String = { fg = c.red },
                Constant = { fg = c.blue },
                ...
                LualineDiagnosticSignInfo = { fg = c.teal, bg = c.surface0 },
                ...
                ['@function.builtin.bash'] = { fg = c.green },
                ['@parameter'] = { fg = c.sky },
                ...
                ['@tag.attribute.jsx'] = { fg = c.teal },
                ['@tag.attribute.tsx'] = { fg = c.teal },
